...
<body>
     ...
     <div class="navbar">
        <ul>
            ...
            <li class="dropdown-li">
                ...
                <ul class="dropdown">
                    <li><a href="#">مساجد</a></li>
                    <li><a href="#">مواقع وأبار</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown-li">
                ...
                <ul class="dropdown">
                    <li><a href="#">متاحف ومراكز</a></li>
                    <li><a href="#">مزارع </a></li>
                    <li><a href="#">مرابط خيل </a></li>
                    <li><a href="#">ملاهي ألعاب</a></li>
                    <li><a href="#">أسواق ومولات</a></li>
                    <li><a href="#">حدائق ومنتزهات</a></li>
                    <li><a href="#">مماشي</a></li>
                    <li><a href="#">سينما</a></li>
                </ul>
            </li>
            <li><a href="#">تقويم الفعاليات</a></li>
            <li><a href="#">متجر بوركت</a></li>
        </ul>
    ...
    <div class="section1">
        ...
        <div class="image-container">
            ...
            <div class="content">
                <h2>مساجد</h2>
                <button>اكتشف مساجد المدينة</button>
            </div>
        </div>
        <div class="image-container">
            ...
            <div class="content">
                <h2>مواقع وآبار</h2>
                <button>اكتشف مواقع وآبار المدينة</button>
            </div>
        </div>
    </div>
    <div class="section2bg">
        ...
        <div class="image-container-small-1">
